...
public class StringUtil {
     ...
     * @return
     */
    public static String getCamelName(String columName) {
     ...
     * @return
     */
    public static String toSecurityString(String str, int startIndex, int length) {
        return toSecurityString(str, startIndex, length, "*");
    }
     ...
     * @return
     */
    public static String toSecurityString(String str, int endLength, int length, String padStr) {
        ...
        if (!m.matches() || str.length() < (endLength + length)) {
            return str;
        }

        String startString = str.substring(0, str.length() - endLength - length);
        String endString = str.substring(str.length() - endLength);

        return startString + StringUtils.rightPad("", length, padStr) + endString;
    }
     ...
     * @return
     */
    public static String newlineByDigit(String str, int digit) {
        if (StringUtils.isEmpty(str)) {
            return "";
        }

        if (str.length() > digit) {
            String addressLine1 = str.substring(0, digit);
            String addressLine2 = str.substring(digit);
            str = addressLine1 + "<br/>" + addressLine2;
        }
    ...
    public static String leftPad(String val, int len) {
        return leftPad(val, len, StringPool.SPACE);
    }
     ...
     * @return
     */
    public static String leftPad(String val, int len, String replaceVal) {
        if (val == null) {
        ...
        for (; tempLen < len; tempLen++) {
            sb.insert(0, replaceVal);
        }
     ...
     * @return
     */
    public static String rightPad(String val, int len) {
        return rightPad(val, len, StringPool.SPACE);
    }
     ...
     * @return
     */
    public static String rightPad(String val, int len, String replaceVal) {
        if (val == null) {
            val = StringUtils.EMPTY;
        }
        int tempLen = 0;
     ...
     * @return
     */
    public static String leftPadByte(String val, int len) {
        return leftPadByte(val, len, StringPool.SPACE);
    }
     ...
     * @return
     */
    public static String leftPadByte(String val, int len, String replaceVal) {
        if (val == null) {
            val = StringUtils.EMPTY;
        }
        int tempLen = 0;
        ...
        for (int i = 0; i < val.length(); i++) {
            String s = String.valueOf(val.charAt(i));
            String s1 = i + 1 < val.length() ? String.valueOf(val.charAt(i + 1)) : "";
            try {
                if (s.getBytes("GB18030").length > len) {
                    break;
                }
                tempLen += s.getBytes("GB18030").length;
                sb.append(s);
                if (tempLen + s1.getBytes("GB18030").length > len) {
                    break;
                }
            } catch (Exception e) {
            }
     ...
     * @return
     */
    public static String rightPadByte(String val, int len) {
        return rightPadByte(val, len, StringPool.SPACE);
    }
     ...
     * @return
     */
    public static String rightPadByte(String val, int len, String replaceVal) {
        if (val == null) {
            val = StringUtils.EMPTY;
        }
        int tempLen = 0;
     ...
     * @return
     */
    public static String[] splitLenByte(String val, int len) {
        if (val == null) {
            val = StringUtils.EMPTY;
        }
        List<String> retList = new ArrayList<>();
        int tempLen = 0;
        int maxLen = val.length();
        StringBuilder sb = new StringBuilder();
        try {
            for (int i = 0; i < maxLen; i++) {
                ...
                sb.append(s);
                if (tempLen + s1.getBytes("GB18030").length > len || i == maxLen - 1) {
     ...
     * @return
     */
    public static String[] splitLen(String val, int len) {
        if (val == null) {
            val = StringUtils.EMPTY;
        }
        List<String> retList = new ArrayList<>();
