...
import com.gogtz.common.collection.ArrayUtil;
...
public class ClassUtil {
    ...
    public static Set<String> getClassPaths(String packageName) {
        String packagePath = packageName.replace(StringPool.PERIOD, StringPool.SLASH);
        Enumeration<URL> resources;
        try {
            resources = getClassLoader().getResources(packagePath);
        } catch (IOException e) {
            throw new UtilException(String.format("Loading classPath [{}] error!", packagePath), e);
        }
    ...
    public static <T> T newInstance(String clazz) {
        try {
            ...
            throw new UtilException(String.format("Instance class [{}] error!", clazz), e);
        }
    }
    ...
    public static <T> T invoke(String className, String methodName, boolean isSingleton, Object[] args) {
        ...
        try {
            ...
            if (null == method) {
                throw new NoSuchMethodException(String.format("No such method: [{}]", methodName));
            }
            if (isStatic(method)) {
    ...
    public static String getPackage(Class<?> clazz) {
        ...
        int packageEndIndex = className.lastIndexOf(StringPool.PERIOD);
    ...
    public static String getPackagePath(Class<?> clazz) {
        return getPackage(clazz).replace(CharPool.PERIOD, CharPool.SLASH);
    }
